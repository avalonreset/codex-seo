...
- GitHub Actions workflow at `.github/workflows/runners-ci.yml` to run:
  - shell syntax checks for install/hook scripts
  - Python compile checks for runner scripts
  - `--help` smoke checks for all SEO runner CLIs
